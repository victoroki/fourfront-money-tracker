                ...
                <form action="{{ route('users.index') }}" method="GET" class="flex flex-col sm:flex-row gap-4">
                    <div class="flex-1">
                        <div class="relative">
                            ...
                            <x-text-input name="search" placeholder="Search by name or email..." class="w-full pl-10" value="{{ request('search') }}" />
                        </div>
                    </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $user->wallets->count() }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-green-600">${{ number_format($user->total_balance, 2) }}</td>
